...
function PostForm({ post }) {
  // this useform give lots of things to like
  //register (to store data)
  // handlesubmit (to send form)
  //watch (to continunious monitor )
  ...
  const submit = async (data) => {
    //if we have a post (want to edit)
    if (post) {
